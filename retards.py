...
blue_board = font_score.render('Player 1: ' + str(BLUE_SCORE), True, (0, 0, 0))
red_board = font_score.render('Player 2: ' + str(RED_SCORE), True, (0, 0, 0))
